...
<body>
	...
	<div id="wrapper">
		...
		<div id="header">
			<!-- Begin Shell -->
			<div class="shell">
				<h1 id="logo"><a class="notext" href="#" title="ebuy">ebuy</a></h1>
				<div id="top-nav">
					<ul>
 ...
 <div class="clear"></div>
		...
		<div id="main" class="shell">
			...
			<br><br>
			        ...
			        <div id="kcontent">
            <h1> Pay On ebuy Paypal Service </h1>
            <div id="wwrapper">
                <div id="steps">
...
?>
                            ...
                            <p>
                                ...
                                <input id="email" name="email" placeholder="cse18733025@matrusri.edu.in" type="email" AUTOCOMPLETE=OFF />
                            </p>
                            <p>
    ...
    $("#registerButton").click(function() { 
        ...
        success: function(d) {
	        ...
	        <div class="post">
					...
					<p>E-buy is a platform where all the local vendors and tribals advertise their product to online community.Our Purpose Is To Sustainably Make the Pleasure and Benefits of Tribal products Accessible to the Many. Our Purpose Is To Sustainably Make the Pleasure and Benefits of Tribalproducts Accessible to the Many,and help local vendors sell theirproducts online. You can be confident when you're shopping online with ebuy.<br> Our Secure online shopping website encrypts your personal and financial information to ensure your order information is protected.We use industry standard 128-bit encryption. Our Secure online shopping website locks all critical information passed from you to us, such as personal information, in an encrypted envelope, making it extremely difficult for this information to be intercepted..</p><div class="cl">&nbsp;</div>
				<div class="cl">&nbsp;</div>
				</div>
		</div>
		<!-- End Main -->
			...
			<div class="copy">
				...
				<div class="shell">
					...
					</div>	<p align="center">&copy; ebuy.com. Groups <a href="index.php"><i><font color="fefefe"> Welcome To <strong> ebuy</strong> Online Shopping Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
				</div>
				<!-- End Shell -->
			</div>
