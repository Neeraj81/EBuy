    ...
    <body>
        ...
        <div class="container">
			...
			<header>
				 ...
				 <h1><p> <a href="Sign In.php"><img src="images/logo.png" alt="" /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>ebuy SMART<strong>Login Form</strong> <span>Please Login Or Sign Up </span></p> </h1>
                        ...
                        <div id="login" class="animate form">
                            <form  action="userValidate.php" method="post" autocomplete="on"> 
                                ...
                                <p> 
                                    ...
                                    <input type="text" name="magaca" required="required" type="text" placeholder="cse18733025@matrusri.edu.in"/>
                                </p>
                                <p> 
