...
<div class="viewcart">
	...
	if(isset($_SESSION["cart_session"]))
    {
		...
		echo '<spa class="midigta"><a  class="a-btn" href="ebuy checkout/paypalprocess.php"><span class="a-btn-text">Proceed On Paypal</span> </a></span>';
		
		echo '<span class="midigta"> <a  class="a-btn" href="ebuy checkout/process.php"> <span class="a-btn-text"> Pay On ebuy</span></a></span>';
		echo '</span>';
		echo '</form>'; 
